...
> [!NOTE]
> This is a **detailed technical report** with actual test results. For implementation guidance, see OCR Processing.
...
![Abhishek Marksheet - English document from Jharkhand Academic Council](../../Report-Final/Abhishek_Marksheet.jpg)
...
![Md. Arsh Marksheet - English Class 11 document from Jharkhand Academic Council](../../Report-Final/Md.Arsh_Marksheet.jpg)
...
![Ujjwal Kumar Marksheet - Hindi document from Bihar](../../Report-Final/Ujjwal_Kumar_Marksheet.png)
...
![Vishal Kumar Marksheet - Hindi handwritten style document](../../Report-Final/Vishal_Kumar_MArksheet.jpg)
...
All test data is sourced from: final-mapping-data.json
...
- **OCR Processing Guide** - Implementation guide and configuration
- **Service Adapters** - How OCR fits into the adapter pattern
- **OCR Mapping** - How extracted text is mapped to structured fields
- **AI Model Parameters** - Bedrock model configuration

---

*Report generated on: 2026-01-29*  
*Test data: 4 marksheet documents (2 English, 2 Hindi)*  
*Total tests: 12 (4 documents × 3 providers)*
